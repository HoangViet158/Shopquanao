        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="editUserForm">
                    <div class="modal-header position-relative justify-content-center border-0">
                    <h5 class="modal-title text-center w-100" id="editUserModalLabel">Chỉnh sửa thông tin User</h5>
                    <button type="button" class="btn-close position-absolute top-0 end-0 m-2" data-bs-dismiss="modal" aria-label="Đóng"></button>
                    </div>
                    <div class="modal-body row g-3">
                    <input type="hidden" id="editUserId" name="MaNguoiDung">
                    ...
                    <button type="button" form="editUserForm" class="btn btn-primary" onclick="updateUser()">Lưu thay đổi</button>
                    </div>
                </form>
            </div>
        </div>
